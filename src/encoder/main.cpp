...
std::vector<char> read_bytes_from_file(const std::size_t bytes_count,
...
int main(int argc, const char * argv[])
{
    try {
        ...
        const auto image_data =
                read_bytes_from_file(bytes_count, args.get_input_file_name());

        utils::Image image{width, height, components_count, image_data.data()};
